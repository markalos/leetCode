...
#         currentPathLength = length + 1
        def deepFirstSearch(currentPos, nextIdx, currentPathLength, res):
            if nextIdx > currentPathLength :
                return currentPathLength, res
            ...
            for ele in tmp :
                ...
                visited[ele] = True;
                path[nextIdx] = ele;
                currentPathLength, res = deepFirstSearch(ele, nextIdx + 1, currentPathLength, res)
                visited[ele] = False
            return currentPathLength, res
        _, res = deepFirstSearch(0, 1, length + 1, res)       
